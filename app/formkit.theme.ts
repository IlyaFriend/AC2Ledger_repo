 ...
 *
 * @checksum - 90cd4e60e5dbbe69a2faf297dc0bfe77518a9bc818ed0df1cb3ed032bdcb813a
 * @variables - radius=rounded,accentColor=primary,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 */
